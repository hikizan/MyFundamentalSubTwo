...
class UsersPresenter : UsersContract.usersPresenter {
    ...
    override fun getDetailUser(username: String?) {
        apiConfig.getApiService().getDetailUser(username!!).enqueue(object: Callback<ResponseDetail>{
            override fun onResponse(
    ...
    override fun getSearch(username: String?) {
        apiConfig.getApiService().getSearchListUser(username!!).enqueue(object: Callback<ResponseSearch>{
            override fun onResponse(
